...
| prometheus.rbacProxy.pullPolicy | string | `nil` | The kube-rbac-proxy image pull policy. |
| prometheus.rbacProxy.repository | string | `"registry.k8s.io/kubebuilder/kube-rbac-proxy"` | The kube-rbac-proxy image repository. |
| prometheus.rbacProxy.tag | string | `"v0.12.0"` | The kube-rbac-proxy image tag. |
